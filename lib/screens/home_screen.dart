...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return ProjectScreenBulder(screenBulder: (context, screenType) {
        return Scaffold(
          appBar: AppBar(
            ...
            onPressed: () {
              ...
              showGeneralDialog(
                      ...
                      pageBuilder: (BuildContext buildContext,
                        ...
                        return InputCleintDialog(title: "اضافة عميل ",)
                            .animate()
                            .fadeIn(duration: Duration(milliseconds: 500));
                      },
                    ).then((value) {
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, i) {
                    return i < data.length ? ListItem(
                        ...
                        screenType: screenType) : SizedBox(
                      height: 100.h ,
                    );
                  });
            },
